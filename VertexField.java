...
cij_field = vector.addVec(vector.mulScalar(normal,facet_totals[i][0] ),cij_field);
...
System.out.println("Total cij field for obs :"+(obs+1)+"  = "+cij_field.x+"   "+cij_field.y+"   "+cij_field.z);
