...
package loop;
public class VertexDirectedEdgeLoop {
  Data data=new Data();
  utility util;
  int target=2;
...
for (int edge_count=0;edge_count<data.getEdges();edge_count++)
{
  ...
  double norm_Robs1_len,norm_Robs2_len,r0_len,max_term,l1,l2,eta,vertex_ij;
  //retrieve facets
...
{
    VertexDirectedEdgeLoop m = new VertexDirectedEdgeLoop();
    m.Facet_Loop();
    m.Extrinsic_Loop();
